...
public abstract class BaseModelDao extends NodeItem {
   ...
   public NodeItem delegateLookupById(String id) throws DaoException {
      return itemDao.lookupById(id);
   }
   ...
   protected OperationsQueue delegateBind(JcrToListMapper mapper) throws DaoException {
