...
public class Accounts extends TableImpl<AccountsRecord> {
	...
	private static final long serialVersionUID = 1239996436;
	 ...
	 */
	public final TableField<AccountsRecord, String> CREATED_BY = createField("created_by", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false), this, "");

	/**
	 * The column <code>cora.accounts.modified_by</code>.
	 */
	public final TableField<AccountsRecord, String> MODIFIED_BY = createField("modified_by", org.jooq.impl.SQLDataType.VARCHAR.length(256).nullable(false), this, "");
