...
public class OrderTests extends TableImpl<OrderTestsRecord> {
	...
	private static final long serialVersionUID = 535488300;
	...
	/**
	 * The column <code>cora.order_tests.indication_type</code>.
	 */
	public final TableField<OrderTestsRecord, String> INDICATION_TYPE = createField("indication_type", org.jooq.impl.SQLDataType.VARCHAR.length(32), this, "");
	...
	/**
	 * The column <code>cora.order_tests.quantity</code>.
	 */
	public final TableField<OrderTestsRecord, Integer> QUANTITY = createField("quantity", org.jooq.impl.SQLDataType.INTEGER, this, "");
	 ...
	 */
	public final TableField<OrderTestsRecord, UUID> CREATED_BY = createField("created_by", org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");

	/**
	 * The column <code>cora.order_tests.modified_by</code>.
	 */
	public final TableField<OrderTestsRecord, UUID> MODIFIED_BY = createField("modified_by", org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");
	...
	public List<ForeignKey<OrderTestsRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<OrderTestsRecord, ?>>asList(Keys.ORDER_TESTS__ORDER_TESTS_ORDER_ID_FKEY, Keys.ORDER_TESTS__ORDER_TESTS_TEST_ID_FKEY);
	}
