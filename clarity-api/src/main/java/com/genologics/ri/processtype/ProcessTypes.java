 ...
 *       
 * 
 * <p>Java class for process-types complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="process-types">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="process-type" type="{http://genologics.com/ri/processtype}process-type-link" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "process-types", propOrder = {
    "processType",
    "previousPage",
    "nextPage"
})
public class ProcessTypes {
    ...
    protected List<ProcessTypeLink> processType;
     ...
     * {@link ProcessTypeLink }
     * 
     * 
     */
    public List<ProcessTypeLink> getProcessType() {
        if (processType == null) {
            processType = new ArrayList<ProcessTypeLink>();
        }
