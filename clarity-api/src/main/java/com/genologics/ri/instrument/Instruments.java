 ...
 *       &lt;sequence>
 *         &lt;element name="instrument" type="{http://genologics.com/ri/instrument}instrument-link" maxOccurs="unbounded" minOccurs="0"/>
...
public class Instruments {
    ...
    protected List<InstrumentLink> instrument;
     ...
     * 
     */
    public List<InstrumentLink> getInstrument() {
        if (instrument == null) {
            instrument = new ArrayList<InstrumentLink>();
        }
