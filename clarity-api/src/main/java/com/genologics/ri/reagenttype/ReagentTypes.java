 ...
 *       
 * 
 * <p>Java class for reagent-types complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="reagent-types">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="reagent-type" type="{http://genologics.com/ri/reagenttype}reagent-type-link" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "reagent-types", propOrder = {
    "reagentType",
    "previousPage",
    "nextPage"
})
public class ReagentTypes {

    @XmlElement(name = "reagent-type")
    protected List<ReagentTypeLink> reagentType;
    ...
    /**
     * Gets the value of the reagentType property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the reagentType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReagentType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ReagentTypeLink }
     * 
     * 
     */
    public List<ReagentTypeLink> getReagentType() {
        if (reagentType == null) {
            reagentType = new ArrayList<ReagentTypeLink>();
        }
