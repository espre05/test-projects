 ...
 *       
 * 
 * <p>Java class for samples complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="sample" type="{http://genologics.com/ri/sample}sample-link" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "samples", propOrder = {
    "sample",
    "previousPage",
    "nextPage"
})
public class Samples {
    ...
    protected List<SampleLink> sample;
     ...
     * 
     */
    public List<SampleLink> getSample() {
        if (sample == null) {
            sample = new ArrayList<SampleLink>();
        }
        return this.sample;
    }
