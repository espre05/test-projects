 ...
 *       &lt;sequence>
 *         &lt;element name="udfconfig" type="{http://genologics.com/ri/configuration}udfconfig-link" maxOccurs="unbounded" minOccurs="0"/>
...
public class Udfs {
    ...
    protected List<UdfconfigLink> udfconfig;
    ...
    /**
     * Gets the value of the udfconfig property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the udfconfig property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getUdfconfig().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<UdfconfigLink> getUdfconfig() {
        if (udfconfig == null) {
            udfconfig = new ArrayList<UdfconfigLink>();
        }
