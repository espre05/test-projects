...
public class MappingFrame extends JFrame implements com.altova.TraceTarget {
	...
	JLabel jOndemand_MapForceLabel0 = new JLabel();
	JTextField jOndemand_MapForceTextField0 = new JTextField();

	JLabel jsubmissionLabel1 = new JLabel();
	JTextField jsubmissionTextField1 = new JTextField();
	...
	private void jbInit() throws Exception {
		jInfoLabel1.setText("THIS APPLICATION WAS GENERATED BY MapForce 2011");
	...
	protected void fillScrollPane() {
		...
		jOndemand_MapForceLabel0.setText("Source instance of Ondemand_MapForce file:");
		jOndemand_MapForceLabel0.setBounds(new Rectangle(15, 10, 438, 23));
		jPanelStructures.add(jOndemand_MapForceLabel0, null);
		jOndemand_MapForceTextField0.setText("D:/_WebDownloads/Ondemand_redactedFileForTestingAtMapForceInLaptop.txt");
		jOndemand_MapForceTextField0.setBounds(new Rectangle(15, 35, 438, 23));
		jOndemand_MapForceTextField0.setEditable(false);
		jPanelStructures.add(jOndemand_MapForceTextField0, null);

		jsubmissionLabel1.setText("Instance of submission.xsd:");
		jsubmissionLabel1.setBounds(new Rectangle(15, 60, 438, 23));
		jPanelStructures.add(jsubmissionLabel1, null);
		jsubmissionTextField1.setText("submission.xml");
		jsubmissionTextField1.setBounds(new Rectangle(15, 85, 438, 23));
		jsubmissionTextField1.setEditable(false);
		jPanelStructures.add(jsubmissionTextField1, null);
    ...
    void jStartButton_actionPerformed(ActionEvent e) {
		if (e.getSource().equals(jStartButton)) {
			...
			MappingMapTosubmission MappingMapTosubmissionObject = new MappingMapTosubmission();


			MappingMapTosubmissionObject.registerTraceTarget(ttc);
			...
			// MappingMapTosubmissionObject.setCloseObjectsAfterRun(false);

			{
				com.altova.io.Input Ondemand_MapForceSource = com.altova.io.StreamInput.createInput("D:/_WebDownloads/Ondemand_redactedFileForTestingAtMapForceInLaptop.txt");			
				com.altova.io.Output submission2Target = new com.altova.io.FileOutput("submission.xml");

				MappingMapTosubmissionObject.run(
						Ondemand_MapForceSource,
						submission2Target);
			}
