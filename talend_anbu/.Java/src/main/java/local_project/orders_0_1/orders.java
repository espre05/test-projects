		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				if (dbschema_tPostgresqlOutput_1 == null
					...
					tableName_tPostgresqlOutput_1 = "sf_orders";
				} else {
				...
				while (rsTable_tPostgresqlOutput_1.next()) {
					...
					if (table_tPostgresqlOutput_1.equals("sf_orders")
				...
				stmtCreate_tPostgresqlOutput_1
						.execute("CREATE TABLE \""
								+ tableName_tPostgresqlOutput_1
								+ "\"(\"Id\" VARCHAR(18)  ,\"OwnerId\" VARCHAR(18)  ,\"ContractId\" VARCHAR(18)  ,\"AccountId\" VARCHAR(18)  ,\"Pricebook2Id\" VARCHAR(18)  ,\"OriginalOrderId\" VARCHAR(18)  ,\"RecordTypeId\" VARCHAR(18)  ,\"EffectiveDate\" TIMESTAMP(0)  ,\"EndDate\" TIMESTAMP(0)  ,\"IsReductionOrder\" BOOL ,\"Status\" VARCHAR(40)  ,\"Description\" VARCHAR(32000)  ,\"CustomerAuthorizedById\" VARCHAR(18)  ,\"CustomerAuthorizedDate\" TIMESTAMP(0)  ,\"CompanyAuthorizedById\" VARCHAR(18)  ,\"CompanyAuthorizedDate\" TIMESTAMP(0)  ,\"Type\" VARCHAR(40)  ,\"BillingStreet\" VARCHAR(255)  ,\"BillingCity\" VARCHAR(40)  ,\"BillingState\" VARCHAR(80)  ,\"BillingPostalCode\" VARCHAR(20)  ,\"BillingCountry\" VARCHAR(80)  ,\"BillingStateCode\" VARCHAR(10)  ,\"BillingCountryCode\" VARCHAR(10)  ,\"BillingLatitude\" FLOAT8 ,\"BillingLongitude\" FLOAT8 ,\"BillingAddress\" VARCHAR(1)  ,\"ShippingStreet\" VARCHAR(255)  ,\"ShippingCity\" VARCHAR(40)  ,\"ShippingState\" VARCHAR(80)  ,\"ShippingPostalCode\" VARCHAR(20)  ,\"ShippingCountry\" VARCHAR(80)  ,\"ShippingStateCode\" VARCHAR(10)  ,\"ShippingCountryCode\" VARCHAR(10)  ,\"ShippingLatitude\" FLOAT8 ,\"ShippingLongitude\" FLOAT8 ,\"ShippingAddress\" VARCHAR(1)  ,\"Name\" VARCHAR(80)  ,\"ActivatedDate\" TIMESTAMP(0)  ,\"ActivatedById\" VARCHAR(18)  ,\"StatusCode\" VARCHAR(40)  ,\"CurrencyIsoCode\" VARCHAR(3)  ,\"OrderNumber\" VARCHAR(30)  ,\"TotalAmount\" FLOAT8 ,\"CreatedDate\" TIMESTAMP(0)  ,\"CreatedById\" VARCHAR(18)  ,\"LastModifiedDate\" TIMESTAMP(0)  ,\"LastModifiedById\" VARCHAR(18)  ,\"IsDeleted\" BOOL ,\"SystemModstamp\" TIMESTAMP(0)  ,\"LastViewedDate\" TIMESTAMP(0)  ,\"LastReferencedDate\" TIMESTAMP(0)  ,\"Data_Release_Date__c\" TIMESTAMP(0)  ,\"ISO_Country_Code__c\" VARCHAR(1300)  ,\"Credit_Card_del__c\" VARCHAR(255)  ,\"Invoice_1_Number__c\" VARCHAR(20)  ,\"Invoice_2_Number__c\" VARCHAR(20)  ,\"Invoice_3_Number__c\" VARCHAR(20)  ,\"PO_Contact_Phone__c\" VARCHAR(40)  ,\"Invoice_4_Number__c\" VARCHAR(20)  ,\"Bill_To_Email__c\" VARCHAR(80)  ,\"Order_Catagory__c\" VARCHAR(4099)  ,\"Other_Carrier_Tracking__c\" VARCHAR(10000)  ,\"Priority__c\" VARCHAR(255)  ,\"Probability__c\" VARCHAR(255)  ,\"Age__c\" FLOAT8 ,\"Report_Release_Date__c\" TIMESTAMP(0)  ,\"Sample_Arrival_Date__c\" TIMESTAMP(0)  ,\"Service_Order_Stage__c\" VARCHAR(255)  ,\"Shipping_Handling__c\" FLOAT8 ,\"Data_Analysis_Group__c\" VARCHAR(255)  ,\"Total_Order__c\" FLOAT8 ,\"Workspace_ID__c\" VARCHAR(255)  ,\"clonoSEQ_Stage__c\" VARCHAR(4099)  ,\"Amount__c\" FLOAT8 ,\"PO_Contact_Email__c\" VARCHAR(80)  ,\"PO_Number_c__c\" VARCHAR(100)  ,\"Bill_To_Phone__c\" VARCHAR(40)  ,\"Lead_Source__c\" VARCHAR(1300)  ,\"Invoice_1_Amount__c\" FLOAT8 ,\"Invoice_1_Revenue_Date__c\" TIMESTAMP(0)  ,\"Invoice_2_Amount__c\" FLOAT8 ,\"Invoice_3_Amount__c\" FLOAT8 ,\"Invoice_3_Unearned_Revenue__c\" BOOL ,\"Invoice_4_Amount__c\" FLOAT8 ,\"Locus__c\" VARCHAR(4099)  ,\"Turnaround_Days__c\" FLOAT8 ,\"Credit_Card__c\" VARCHAR(19)  ,\"Sec_code__c\" VARCHAR(3)  ,\"Order_Notes__c\" VARCHAR(100000)  ,\"Expiration__c\" VARCHAR(5)  ,\"Billing_To_Name__c\" VARCHAR(255)  ,\"Ship_To_Name__c\" VARCHAR(255)  ,\"Related_Case__c\" VARCHAR(18)  ,\"Related_Order__c\" VARCHAR(18)  ,\"Resolution__c\" VARCHAR(4099)  ,\"Deadline_Date__c\" TIMESTAMP(0)  ,\"Accounts_Payable_Contact_Email__c\" VARCHAR(80)  ,\"Accounts_Payable_Contact_Phone__c\" VARCHAR(40)  ,\"Sample_Rejection_Criteria__c\" VARCHAR(255)  ,\"Sample_Rejection_Jeopardy__c\" BOOL ,\"Ship_Attn_To_Email__c\" VARCHAR(80)  ,\"PO_Receipt_Date__c\" TIMESTAMP(0)  ,\"Quantity_Released__c\" FLOAT8 ,\"S_H_Tax__c\" FLOAT8 ,\"Total_Tax__c\" FLOAT8 ,\"Legal_Entity__c\" VARCHAR(255)  ,\"Quote_No__c\" VARCHAR(15)  ,\"Discount_percent__c\" FLOAT8 ,\"Total_Discount__c\" FLOAT8 ,\"Total_Invoice_AmountsOld__c\" FLOAT8 ,\"X2014_Total_Invoice_AmountsOld__c\" FLOAT8 ,\"Ship_to_Contact__c\" VARCHAR(1300)  ,\"Sales_Tax2__c\" FLOAT8 ,\"Tax2__c\" FLOAT8 ,\"User__c\" VARCHAR(18)  ,\"Street__c\" VARCHAR(50)  ,\"City__c\" VARCHAR(20)  ,\"State__c\" VARCHAR(20)  ,\"Zip__c\" VARCHAR(10)  ,\"Country__c\" VARCHAR(20)  ,\"Indication__c\" VARCHAR(255)  ,\"User_Phone__c\" VARCHAR(40)  ,\"Need_by__c\" TIMESTAMP(0)  ,\"Related_Contract__c\" VARCHAR(18)  ,\"Invoice__c\" BOOL ,\"Accession_Date__c\" TIMESTAMP(0)  ,\"Reconciliation_Date__c\" TIMESTAMP(0)  ,\"Test_Order_Date__c\" TIMESTAMP(0)  ,\"Clinical_Sales_Territory__c\" VARCHAR(1300)  ,\"Block__c\" VARCHAR(255)  ,\"Physician__c\" VARCHAR(18)  ,\"Sample_Quantity_Received__c\" FLOAT8 ,\"Order_Received_Date__c\" TIMESTAMP(0)  ,\"Order_Value__c\" FLOAT8 ,\"Sales_Territory__c\" VARCHAR(1300)  ,\"Pharma_Sponsored__c\" BOOL ,\"Form_of_Payment_Received_or_Negotiated__c\" BOOL ,\"VAT__c\" VARCHAR(20)  ,\"Campaigns__c\" VARCHAR(18)  ,\"Purchase_Order_Record__c\" VARCHAR(18)  ,\"Broker_Account__c\" VARCHAR(18)  ,\"Sample_Lab_Location__c\" VARCHAR(4099)  ,\"Physician_Full_Name__c\" VARCHAR(1300)  ,\"Estimated_Invoice_Date__c\" TIMESTAMP(0)  ,\"dermoSEQ_Stage__c\" VARCHAR(4099)  ,\"Sales_Credit_Date__c\" TIMESTAMP(0)  ,\"Broker_Tax_ID__c\" VARCHAR(1300)  ,\"Broker_ID_Number__c\" VARCHAR(1300)  ,\"Pharma__c\" VARCHAR(4099)  ,\"Broker_Contact__c\" VARCHAR(18)  ,\"Sequencing_Completion_Deadline_Date__c\" TIMESTAMP(0)  ,\"Distributor__c\" VARCHAR(255)  ,\"Broker_Address__c\" VARCHAR(1300)  ,\"Broker_Contact_Phone__c\" VARCHAR(40)  ,\"Broker_Contact_Email__c\" VARCHAR(80)  ,\"Ship_To_Contact_With_PO__c\" VARCHAR(1300)  ,\"Extractions_Needed__c\" BOOL ,\"Attn_To__c\" VARCHAR(1300)  ,\"Mouse_TCRB_Block__c\" VARCHAR(255)  )");
...
/************************************************************************************************
 * 230343 characters generated by Talend Open Studio for ESB on the March 9,
 * 2016 5:04:50 PM PST
 ************************************************************************************************/
