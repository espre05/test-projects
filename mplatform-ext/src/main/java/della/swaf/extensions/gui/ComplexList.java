...
public class ComplexList {
   ...
   public ComplexList(EventList list, Comparator comparator) {
      init(list, comparator);
   }

   private void init(EventList list, Comparator comparator) {
   ...
   private void init() {
      this.init(sourceList, comparator);
   }
   ...
   public void setTextMatcher(TextMatcherEditor matcherEditor) {
      ...
      FilterList textFilteredList = new FilterList(sourceList, matcherEditor);
      init(textFilteredList, comparator);
   }
