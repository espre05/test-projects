 ...
 *       &lt;sequence>
 *         &lt;element name="process" type="{http://genologics.com/ri/process}process-link" maxOccurs="unbounded" minOccurs="0"/>
...
public class Processes {
    ...
    protected List<ProcessLink> process;
     ...
     * 
     */
    public List<ProcessLink> getProcess() {
        if (process == null) {
            process = new ArrayList<ProcessLink>();
        }
        return this.process;
    }
