 ...
 *       &lt;sequence>
 *         &lt;element name="project" type="{http://genologics.com/ri/project}project-link" maxOccurs="unbounded" minOccurs="0"/>
...
public class Projects {
    ...
    protected List<ProjectLink> project;
     ...
     * 
     */
    public List<ProjectLink> getProject() {
        if (project == null) {
            project = new ArrayList<ProjectLink>();
        }
        return this.project;
    }
    ...
    public String toString() {
      ...
      builder.append("Projects [project=");
