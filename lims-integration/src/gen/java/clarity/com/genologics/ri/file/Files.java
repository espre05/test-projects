 ...
 *       &lt;sequence>
 *         &lt;element name="file" type="{http://genologics.com/ri/file}file-link" maxOccurs="unbounded" minOccurs="0"/>
...
public class Files {
     ...
     * 
     */
    public List<FileLink> getFile() {
        if (file == null) {
            file = new ArrayList<FileLink>();
        }
        return this.file;
    }
