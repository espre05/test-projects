...
public class MP3 {
	...
	public MP3(String path) throws FileTagReadException {
	...
	public String getTrackString() {
		String value = getString("mp3.id3tag.track");
	...
	public String getBitRate() {
		Integer bitRate = getInteger("mp3.bitrate.nominal.bps");
		return bitRate.toString();
	}

	public String getComposer() {
		return getString("mp3.id3tag.composer");
	}
	...
	public void setData(String key, String value) {
		String libSpecificKey = Id3Tag.getProperty(key);
	...
	public String getEncodedBy() {
		return getString("mp3.id3tag.encoded");
	}

	public String getDisc() {
		return getString("mp3.id3tag.disc");
	}
