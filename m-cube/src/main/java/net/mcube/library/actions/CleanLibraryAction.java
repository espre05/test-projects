...
public class CleanLibraryAction extends AbstractAction {

	private Application application;

	public CleanLibraryAction(Application application) {
		this.application = application;
	}

	public void actionPerformed(ActionEvent e) {

		CleanLibraryOperation op = new CleanLibraryOperation((LibraryImpl) application.getLibrary());
